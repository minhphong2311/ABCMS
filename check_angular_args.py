...
async def main():
    async with async_playwright() as p:
        ...
        args = await page.evaluate('''() => {
            ...
            return {
                addMenu: service.addMenu.toString(),
                addChildMenu: service.addChildMenu.toString()
            };
        }''')
        print('addMenu args:', args['addMenu'][:200])
        print('addChildMenu args:', args['addChildMenu'][:200])
